...
vector_binary = os.path.join(DATA_DIR, 'thai2vec/thai2vec02.bin')
model = KeyedVectors.load_word2vec_format(vector_binary,binary=True)

def index_embedding_words(vocab_file):
    """Put all the words in vocab_file into a set."""
    vocab_file= os.path.join(DATA_DIR, 'thai2vec/thai2vec02.vocab')
